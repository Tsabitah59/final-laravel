               ...
               <div class="h-auto">
                    <div>
                         <div class="mb-4">
                              ...
                              <input type="text" name="name" required class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full px-5 py-2" placeholder="Input Category" required />
                              @error('name')
                         ...
                         <div class="mb-4">
                              ...
                              <input type="text" name="slug" required class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full px-5 py-2" placeholder="Input Category Slug" required />
                              @error('slug')
                              <small class="text-red-600">{{ $message }}</small>
                              @enderror
                         </div>
                         ...
                         <div class="mb-4">
                              ...
                              <textarea name="description" required class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full px-5 py-2" placeholder="Input Description" required></textarea>
                              @error('description')
                              <small class="text-red-600">{{ $message }}</small>
                              @enderror
                         </div>
